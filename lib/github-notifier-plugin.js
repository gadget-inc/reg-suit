...
class GitHubNotifierPlugin {
    ...
    init(config) {
        ...
        this._prCommentBehavior = (_a = config.options.prCommentBehavior) !== null && _a !== void 0 ? _a : "default";
        this._setCommitStatus = config.options.setCommitStatus !== false;
        this._commitStatusBehavior = (_b = config.options.commitStatusBehavior) !== null && _b !== void 0 ? _b : "report-failed";
        this._shortDescription = (_c = config.options.shortDescription) !== null && _c !== void 0 ? _c : false;
    ...
    notify(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updateStatusBody = Object.assign(Object.assign({}, this._apiOpt), { sha1,
                description, state: this._commitStatusBehavior === "link-only" ? "success" : state });
            if (params.reportUrl)
            ...
            if (this._prComment) {
                if (head.type === "branch" && head.branch) {
                    const prCommentBody = Object.assign(Object.assign({}, this._apiOpt), { behavior: this._prCommentBehavior, branchName: head.branch.name, headOid: sha1, failedItemsCount,
                        newItemsCount,
                        deletedItemsCount,
